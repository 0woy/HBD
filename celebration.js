  ...
  function setupDuriInteraction() {
    ...
    const duriDialogues = {
      1: [
        ...
        '오늘이 지은이 생일이라 안 된다구요?',
        '그게 제가 호빵을 먹는 거랑 무슨 상관이죠? 별꼴이야 진짜.',
        '(두리가 유유히 사라진다...)',
      ...
      2: [
        '살려주세요!!! 살려주세요!!!',
        '(후두엽을 먹히고 있는 두리가 외친다..)',
        '이 사람이 제 머리를 못 먹게 막아주세요!',
        '(두리를 구해준다..)',
        `힘이 다 빠져버렸어요.. <br> 이 꽃다발을 지은에게 전달해 주시겠어요?`,
        `(하루종일 두리가 물고 있었는지, 꽃다발이 축축하다..)`,
      ],
      3: [
        '...',
        '(예쁜 목걸이를 한 두리가 사색에 잠겨있다.)',
        '닭두리탕이 무슨 의미인가요?..',
        '(닭두리탕의 의미를 깨달은 두리는 잠시 생각한다.)',
        '충격적이네요..',
        `발가벗겨진 기분이에요. <br> 이 목걸이 당신께 드릴게요...`,
        '(두리가 목걸이를 내민다.)',
      ],
    };
